...
public class Color {
	...
	public final static Color yellow=new Color(210, 190, 4);
	public final static Color blue = new Color(17, 78, 238);
	public final static Color green = new Color(27, 177, 82);
	public final static Color red = new Color(110, 20, 10);
	public final static Color thelet = new Color(6, 242, 249);
	public final static Color ctubes = new Color(0, 70, 0);
	/**
